...
begin
    ...
    writeln('Numero de elementos en la cola original: ', uColaInteger.num_elems(cola));
    writeln('Numero de elementos en la cola modificada: ', uColaIntegerMod.num_elems(colaMod));
    writeln('Coinciden los tamanos de las colas? ', uColaInteger.num_elems(cola) = uColaIntegerMod.num_elems(colaMod));
...
var
    ...
    elapsedTime: Double;
begin
    { Probamos a meter 10000 elementos en la cola }
    ...
    writeln('Tiempo que tarda la funcion `num_elems` de la cola original: ', elapsedTime:0:2, ' ms');

    startTime := Now;
    uColaIntegerMod.num_elems(colaMod);
    endTime := Now;
    elapsedTime := MilliSecondsBetween(endTime, startTime);
    writeln('Tiempo que tarda la funcion `num_elems` de la cola modificada: ', elapsedTime:0:2, ' ms');
end;
